...
const ArchitectureIntelligencePage = lazy(() => import("./pages/ArchitectureIntelligencePage"));
    ...
    <Routes>
      ...
      >
        ...
        <Route
          path="architecture"
          element={
            <RequireRole routeKey="architecture">
              <SuspendedRoute Component={ArchitectureIntelligencePage} />
            </RequireRole>
          }
        />
      </Route>
