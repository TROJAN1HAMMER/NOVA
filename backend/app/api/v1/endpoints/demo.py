...
@router.post("/reset")
def reset_demo_environment(user: Any = Depends(require_permission("system_manage"))) -> Dict[str, Any]:
...
def run_vulnerable_analysis(user: Any = Depends(require_permission("security_read"))) -> Dict[str, Any]:
...
def trigger_contradiction(user: Any = Depends(require_permission("security_read"))) -> Dict[str, Any]:
...
def apply_remediation(user: Any = Depends(require_permission("security_write"))) -> Dict[str, Any]:
...
@router.get("/state")
def get_demo_state(user: Any = Depends(require_permission("security_read"))) -> Dict[str, Any]:
