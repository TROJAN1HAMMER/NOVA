...
async def run_master_seed():
    ...
    async with AsyncSessionLocal() as session:
        ...
        admin = user_objects["admin@nova.ai"]
        sec = user_objects["security@nova.ai"]
        dev = user_objects["dev@nova.ai"]
        print(f"✅ Users ready. Admin ID: {admin.id}")
        ...
        for src, tgt, rtype in relations_data:
            ...
            if s_ent and t_ent:
                ...
                if not res.scalars().first():
                    ...
                    session.add(rel)
        await session.commit()
        print("✅ Knowledge Graph Entities & Relations ready.")
