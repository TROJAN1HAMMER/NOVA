...
async def main():
    ...
    async with AsyncSessionLocal() as session:
        ...
        admin = users["admin@nova.ai"]
        sec = users["security@nova.ai"]
        dev = users["dev@nova.ai"]
        print(f"Users seeded: {len(users)} users. Admin: {admin.id}")

        print("--- Step 2: Repositories ---")
        repo_specs = [
        ...
        print("--- Step 3: Knowledge Documents & Chunks ---")
        pci_grp = uuid.uuid4()
        fapi_grp = uuid.uuid4()
        nist_grp = uuid.uuid4()
        zt_grp = uuid.uuid4()
        ...
        for fname, dtype, ver, grp, is_lat, auth, tags, chunks_list in docs:
            ...
            # Clear and reinsert chunks to be clean
        ...
        print("--- Step 4: Knowledge Graph Entities & Relations ---")
        pci_d = doc_objs["PCI_DSS_v4.0_Banking_Security_Standard.pdf"]
        owasp_d = doc_objs["OWASP_Financial_API_Security_Guide.md"]
        nist_d = doc_objs["NIST_SP_800_53_Control_Baselines.pdf"]
        ...
        print("--- Step 5: FAQ Rules & Gap Inbox ---")
        ...
        print("--- Step 6: Assistant Chat Sessions & Messages ---")
        ...
        print("--- Step 7: Audit Logs, Telemetry & Feedback ---")
        ...
        print("--- Step 8: Security Intelligence Context Graph, Assets & Assessments ---")
        ...
        print("--- Step 9: Posture Snapshots ---")
